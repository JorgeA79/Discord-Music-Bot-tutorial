...
.setThumbnail(process.env.BOT_AVATAR)
  ...
  .addField(":credit_card:  Economy", "\`balance\` \`daily\` \`slots\` \`catch\` \`catch sell\` \`mine sell\`\n\u200b", true)      
  .addField(":8ball: Fun & Games", "\`8ball\` \`flip\` \`head\` or \`tail\` \`say\` \`ship\` \`slots\` \`ratewaifu\` \`catch\` \`catch inv\` \`mine\`\n\u200b", true)   
