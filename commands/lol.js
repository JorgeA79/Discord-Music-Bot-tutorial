...
module.exports = {
  ...
  try {
   ...
   .then(res => res.json()).then(bodyX => {    
      ...
      if(bodyX.matches.length > 10){
      const wl1 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[0].gameId}${api}`
      const wl2 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[1].gameId}${api}`
      const wl3 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[2].gameId}${api}`
      const wl4 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[3].gameId}${api}`
      const wl5 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[4].gameId}${api}`
      const wl6 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[5].gameId}${api}`
      const wl7 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[6].gameId}${api}`
      const wl8 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[7].gameId}${api}`
      const wl9 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[8].gameId}${api}`
      const wl10 = `${protocol}${region}/lol/match/v4/matches/${bodyX.matches[9].gameId}${api}`
      
      request(wl1, function (error, response, bodyN) {
   ...
   request('http://ddragon.leagueoflegends.com/cdn/10.11.1/data/de_DE/champion.json', function (error, response, bodyNN) {
    ...
    .addField('Last Games', `10G ${winsxd}W ${losesxd}L`, false)
    .addField('\u200b', `\u200b`, true)
